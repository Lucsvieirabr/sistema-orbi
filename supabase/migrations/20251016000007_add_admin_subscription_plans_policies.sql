...
DROP POLICY IF EXISTS "Admins podem criar planos de assinatura" ON public.subscription_plans;
DROP POLICY IF EXISTS "Admins podem atualizar planos de assinatura" ON public.subscription_plans;
